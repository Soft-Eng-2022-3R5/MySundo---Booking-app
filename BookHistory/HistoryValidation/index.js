...
export default function HistoryValidation({navigation}){
    ...
    <StatusBar barStyle='dark-content' translucent backgroundColor="transparent"/>
      ...
      <View style={styles.navbar}>
            ...
            <TouchableOpacity style={styles.backbutton} onPress={()=>{
                ...
                <Text style={styles.fontstyle1}>Booking History</Text>
                
              
      </View>
      
      <Text style={styles.fontstyle2}>No booking history at this moment.</Text>
    </View>
)
}